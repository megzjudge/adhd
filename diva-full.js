...
const DIVA_FULL = [
 ...
 },
 {
  ...
  "comments": [
   ...
   {
    "sec": "C",
    "text": "I read harry potter 3, 18 times in a year I think, in year 6. I dug through as much as I could get my hands on from an approx 50-book young adult series and such prior to that (reference <a href=https://www.goodreads.com/series/64593-pony-pals>1</a> & <a href=https://www.goodreads.com/series/67646-pony-pals-super-specials>2</a>). I was always an avid reader. My issue as an adult is compartmentalising my distractions. I lived in a van for a few weeks when I was 25, I read I think 10 books in two weeks if I recall. I just plowed through them. I love to read. But I find it hard to justify when I could be doing something that \"lasts\" forever. Which is never the case but anyway. Like I can make a website thats useful for other people - or, I can do something like read and then share that information to others - but the former is easier to stabilise results for. So I try audiobooks, but i listen to them, say like an hour or two, once a fortnight, it is infrequent but I do always aim to finish them and often I eventually do. Right now I’m like 8 hours into <https://www.audible.com.au/pd/The-Idiot-Audiobook/B01N3ATK5K>Dostoyevsky</a> and am an hour into <https://www.audible.com.au/pd/A-Billion-Years-of-Sex-Differences-Audiobook/B0FYR4BM3Q>A Billion Years of Sex Differences: How Evolution Shaped the Minds of Men and Women</a>… the last few books I listened to were <https://www.youtube.com/@CosmicSkeptic>Essays in Love</a> a fiction prose about love upon recommendation from Alex O’Connor, as I’d listened to podcasts from the author and genuinely think hes a great philosopher and also <https://www.audible.com.au/pd/Troubled-Audiobook/B0CJ3DF83W>Troubled</a> by <https://www.robkhenderson.com/>Rob Henderson</a>."
   }
  ]
 },
 {
  ...
  "comments": [
   {
    "sec": "A",
    "text": "My perfectionism is more about my creations than my physical self. I try to avoid stress by keeping calm in most situations, control my internal fury, and eat well (vegetarian for 11 years) to maintain my physical appearance, I never get beyond 15kgs overweight (there is a mental threshold I believe in how the other interacts with you, 5kgs over makes certain shallow people avoid you and too fat makes the general caucus of people avoid you so I try and not go over this threshold, for me this is <50kg and >70kg) - but I don't focus on it, its a passive thing and generally I don't care at all about my phsycial appearance. I will show up to somewhere in a black hoodie with my hair not done and no makeup without issue. But, in terms of perfectionism as a whole I have two distinct modes - I give up on perfectionism from the start or I over embellish into it. I will do 200 iterations of a piece of art on Midjourney trying to make the artwork perfect to my standards, I will sit and tweak even the slightest little colour or spacing errors on a website and do 300 commits on Github, I will spend fifteen minutes trying to find one word that correctly exemplifies what I am trying to say - I realised when I was young that English is exceptionally bad at things that I now can explain due to language variability being and English teacher and trying to learn 5 other languags - English is a business language, its easier for then foreigners to learn (has no gender, politeness system, etc) but it struggles differentially to Romance languages in explaining feelings and expressions of the primordial Self. English is of course a Germanic language, it just struggles to express the feminine as well as it does stoicism, German's ability in itself to craft new variants of words is fantastic and I enjoy it thoroughly, I dont dislike English but... even when you get into International English/Common English as is now generally speaking much more common (as there is more second-language speakers of english than first-language speakers, and so content is made to span a wider audience of listeners), so the words may even exist but they are so far outside of anyone's lexicon that you can't use them for anything pointed towards the Other in discourse of any form. Very complex, language. But yes so I started doing this as a child but I have the two modes, 'fuck it' and 'obsessiveism' - its entirely the same with my view of love/men."
   },
  ]
 }
];
