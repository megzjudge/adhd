  ...
  "comments": [
   {
    "sec": "C",
    "paras": [
     "If I sit and consume a book, sometimes I will be daydreaming and read but not realise what I've read and have to go back and re-read. I believe this also happens in conversation. But often, I just \"dual boot\" as one would call it in IT. I daydream whilst someone is talking and can gauge what they have said if I wasn't 100% attentive to them. Ie, sentence structure is predictive (as an ESL teacher I taught students there are two kinds of words, filler words and context words - to speed up your listening, like skim reading, skim listening would mean to only listen to context words) and so I feel my brain does this even when I am daydreaming whilst listening and I piece those words together to understand enough even if my mind is nearly fully elsewhere."
    ]
   }
  ],
  "notes": []
  ...
  "comments": [
   {
    ...
    "paras": [
     ...
     "In year six I did no homework the entire year to the sheer fury of my teacher - the school moved me from a disagreeable stern teacher into a softer amiable teacher whom I walked all over the entire year unfortunately for her. I needed the disagreeable teacher and remember her fondly even though I had her only a few weeks (she wrote a and lot on either side of the board and I never forgot they were two separate words), I got bumped up to the other class to fill numbers."
  ...
  "comments": [
   {
    ...
    "paras": [
     ...
     "I feel I burnt out on sociability quite young and so get bored at the repetitiveness of social activities and interactions. My brain thinks, \"I could be at home coding, watching a podcast, playing a game, having sex, etc\"."
    ]
   }
  ]
 },
  ...
  "comments": [
   ...
   },
   {
    ...
    "paras": [
     ...
     "In terms of things I didn't answer - I read harry potter 3, 18 times in year 6, I'd sit up the back of class and just read all day. I dug through as much as I could get my hands on from an approx 50-book young adult series and such prior to that (reference [1](https://www.goodreads.com/series/64593-pony-pals) & [2](https://www.goodreads.com/series/67646-pony-pals-super-specials)). I was always an avid reader. My issue as an adult is compartmentalising my distractions. I lived in a van for a few weeks when I was 25, I read I think 10 books in two weeks if I recall. I just plowed through them. I love to read. But I find it hard to justify when I could be doing something that hypothetically lasts forever. Which is never the case but anyway. Like I can make a website thats useful for other people - or, I can do something like read and then share that information to others - but the former is easier to stabilise results for. So I try audiobooks, but i listen to them, say like an hour or two, once a fortnight, it is infrequent but I do always aim to finish them and often I eventually do. Right now I’m like 8 hours into [Dostoyevsky](https://www.audible.com.au/pd/The-Idiot-Audiobook/B01N3ATK5K) and am an hour into [A Billion Years of Sex Differences: How Evolution Shaped the Minds of Men and Women](https://www.audible.com.au/pd/A-Billion-Years-of-Sex-Differences-Audiobook/B0FYR4BM3Q)… the last few books I listened to were [Essays in Love](https://www.audible.com.au/pd/Essays-in-Love-Audiobook/B00FG9BJNC) a fiction prose about love upon recommendation from [Alex O’Connor](https://www.youtube.com/@CosmicSkeptic), as I’d listened to podcasts from the author and genuinely think hes a great philosopher and also [Troubled](https://www.audible.com.au/pd/Troubled-Audiobook/B0CJ3DF83W) by [Rob Henderson](https://www.robkhenderson.com/)."
    ]
   }
  ]
 },
  ...
  "comments": [
   {
    ...
    "paras": [
     ...
     "But, in terms of perfectionism as a whole I have two distinct modes - I give up on perfectionism from the start or I over embellish into it. I will do 200 iterations of a piece of art on Midjourney trying to make the artwork perfect to my standards, for websites I will sit and tweak even the slightest little colour or spacing errors and do 300 commits on Github, I will spend fifteen minutes trying to find one word when writing that correctly exemplifies what I am trying to say. I realised when I was young that English is exceptionally bad at things, that I now can explain due to language variability (being an ESL English teacher and trying to learn 5 other languags over the course of my life) - English is a business language, so it's easier for foreigners to learn overall (has no gender (even german does, approx 38% do), no politeness system (re, jap kor indo), it's not a tonal languge (thai viet mand etc)) but it struggles differentially to Romance languages in explaining feelings and expressions of the primordial Self. English is of course a Germanic language, so it just struggles to express chaotic emotionality as well as it does stoic verbosity, German's ability in itself to craft new variants of words is fantastic and I enjoy it thoroughly, I dont dislike English but... even when you get into the versions of English that are being taught, International English/Common English is now generally speaking much more common (as there is more second-language speakers of english than first-language speakers and so content is made to span the widest audience of listeners without being conscious sometimes of it, you just innately edit yourself to be more easily understood online), so the words may even exist but they are so far outside of anyone's lexicon that you can't use them for anything pointed towards the Other in discourse in any form. Very complex... language. But yes so I started doing this as a child (I starting writing novellas at about 8 in writing my dreams into stories - I had a reoccuring dream as a kid of three wolves chasing me, and also other dreams of things my dog and I would do, and imagining sitting on the roof of somewhere watching something on fire and trying to explain how I felt as a kid, things like this which ended up manifested into the written word over time), but I have the two modes, 'fuck it' and 'obsessivism' - its entirely the same with my interactions with love/men."
    ]
   }
  ]
 }
